...
export ISAACSIM_PATH=/root/IsaacSim/_build/linux-x86_64/release
...
Exec=bash -c '/root/IsaacSim/_build/linux-x86_64/release/isaac-sim.sh --allow-root --/persistent/isaac/asset_root/default="/root/Assets_IsaacSim/Assets/Isaac/5.1"'
Icon=/root/IsaacSim/_build/linux-x86_64/release/data/omni.isaac.sim.png
Terminal=false
